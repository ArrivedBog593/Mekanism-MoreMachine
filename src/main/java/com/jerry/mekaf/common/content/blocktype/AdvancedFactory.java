...
public class AdvancedFactory<TILE extends MMTileEntityFactory<?>> extends MMMachine.MMFactoryMachine<TILE> {
    ...
    public static class MMFactoryBuilder<FACTORY extends AdvancedFactory<TILE>, TILE extends MMTileEntityFactory<?>, T extends MMMachineBuilder<FACTORY, TILE, T>>
        ...
        public static <TILE extends MMTileEntityFactory<?>> MMFactoryBuilder<AdvancedFactory<TILE>, TILE, ?> createMMFactory(Supplier<?> tileEntityRegistrar, AdvancedFactoryType type,
                                                                                                                             FactoryTier tier) {
            // this is dirty but unfortunately necessary for things to play right
            MMFactoryBuilder<AdvancedFactory<TILE>, TILE, ?> builder = new MMFactoryBuilder<>(new AdvancedFactory<>((Supplier<TileEntityTypeRegistryObject<TILE>>) tileEntityRegistrar,
