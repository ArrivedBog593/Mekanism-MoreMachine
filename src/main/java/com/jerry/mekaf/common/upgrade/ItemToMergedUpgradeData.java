...
public class ItemToMergedUpgradeData implements IUpgradeData {
    ...
    public final List<MergedChemicalTank> outputTanks;
    public final CompoundTag components;


    public ItemToMergedUpgradeData(boolean redstone, IRedstoneControl.RedstoneControl controlType,
                                   IEnergyContainer energyContainer, int operatingTicks, EnergyInventorySlot energySlot,
                                   InputInventorySlot inputSlot, MergedChemicalTank outputTank, List<ITileComponent> components) {
    ...
    public ItemToMergedUpgradeData(boolean redstone, IRedstoneControl.RedstoneControl controlType,
                                   ...
                                   List<IInventorySlot> inputSlots, List<MergedChemicalTank> outputTanks, boolean sorting, List<ITileComponent> components) {
