...
public class LMTileEntityTypes {
    ...
    public static final TileEntityTypeRegistryObject<TileEntityLargeRotaryCondensentrator> LARGE_ROTARY_CONDENSENTRATOR = LM_TILE_ENTITY_TYPES.mekBuilder(LMBlocks.LARGE_ROTARY_CONDENSENTRATOR, TileEntityLargeRotaryCondensentrator::new)
