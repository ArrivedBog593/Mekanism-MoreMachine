...
public class RotCondHolidayInfo extends BaseHolidayInfo {
    ...
    public static void onStitch(TextureAtlasStitchedEvent event) {
        ...
        HOLIDAY_MINER_TRANSFORMS = Map.of(
                AprilFools.INSTANCE, QuadTransformation.list(
                        ...
                        QuadTransformation.TextureFilteredTransformation.of(suffixTexture(atlas, Mekmm.rl("block/large_machine/large_rotary_condensentrator/screen_"), "afd_text"), IS_SECOND)),
