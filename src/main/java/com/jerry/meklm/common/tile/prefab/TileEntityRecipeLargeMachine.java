...
public abstract class TileEntityRecipeLargeMachine<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableLargeMachine implements IRecipeLookupHandler<RECIPE> {
