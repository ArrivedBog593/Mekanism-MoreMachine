...
public class MoreMachineGuiSortingTab extends GuiInsetElement<TileEntityMoreMachineFactory<?>> {

    public MoreMachineGuiSortingTab(IGuiWrapper gui, TileEntityMoreMachineFactory<?> tile) {
