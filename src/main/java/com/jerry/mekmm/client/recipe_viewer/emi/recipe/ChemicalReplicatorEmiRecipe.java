...
public class ChemicalReplicatorEmiRecipe extends MekanismEmiRecipe<MMBasicChemicalChemicalToChemicalRecipe> {
    ...
    public ChemicalReplicatorEmiRecipe(MekanismEmiRecipeCategory category, ResourceLocation id, MMBasicChemicalChemicalToChemicalRecipe mmBasicItemStackChemicalToItemStackRecipe) {
    ...
    public void addWidgets(WidgetHolder widgetHolder) {
        ...
        initTank(widgetHolder, GuiChemicalGauge.getDummy(chemical_left, this, 7, 4), input(1));
        GaugeType chemical_right = GaugeType.STANDARD.with(DataType.INPUT);
        initTank(widgetHolder, GuiChemicalGauge.getDummy(chemical_right, this, 28, 4), input(0));
        GaugeType chemical_output = GaugeType.STANDARD.with(DataType.INPUT);
        initTank(widgetHolder, GuiChemicalGauge.getDummy(chemical_output, this, 131, 4), input(2));
