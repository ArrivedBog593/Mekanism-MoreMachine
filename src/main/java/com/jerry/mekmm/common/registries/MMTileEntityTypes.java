...
public class MMTileEntityTypes {
    ...
    static {
        for (FactoryTier tier : EnumUtils.FACTORY_TIERS) {
            ...
            FACTORIES.put(tier, MMFactoryType.CNC_LATHING, MM_TILE_ENTITY_TYPES.register(MMBlocks.getMMFactory(tier, MMFactoryType.CNC_LATHING), (pos, state) -> new TileEntityItemStackToItemStackMMFactory(MMBlocks.getMMFactory(tier, MMFactoryType.CNC_LATHING), pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient));
            FACTORIES.put(tier, MMFactoryType.CNC_ROLLING_MILL, MM_TILE_ENTITY_TYPES.register(MMBlocks.getMMFactory(tier, MMFactoryType.CNC_ROLLING_MILL), (pos, state) -> new TileEntityItemStackToItemStackMMFactory(MMBlocks.getMMFactory(tier, MMFactoryType.CNC_ROLLING_MILL), pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient));
