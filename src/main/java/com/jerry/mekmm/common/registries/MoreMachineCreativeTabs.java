...
public class MoreMachineCreativeTabs {
    ...
    public static final CreativeTabRegistryObject MEKANISM_MORE_MACHINE = MM_CREATIVE_TABS.registerMain(MoreMachineLang.MEKANISM_MORE_MACHINE, MoreMachineItems.SCRAP, builder ->
