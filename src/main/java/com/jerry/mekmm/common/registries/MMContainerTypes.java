...
public class MMContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityChemicalReplicator>> CHEMIcAL_REPLICATOR = MM_CONTAINER_TYPES.register(MMBlocks.CHEMICAL_REPLICATOR, TileEntityChemicalReplicator.class);
