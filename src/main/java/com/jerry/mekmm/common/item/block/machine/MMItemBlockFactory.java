...
public class MMItemBlockFactory extends ItemBlockMachine {

    public MMItemBlockFactory(MMBlockFactoryMachine.MMBlockFactory<?> block) {
        super(block);
    }
    ...
    protected void addTypeDetails(@NotNull ItemStack stack, Level world, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        Attribute.ifPresent(getBlock(), MMAttributeFactoryType.class, attribute -> tooltip.add(MekanismLang.FACTORY_TYPE.translateColored(EnumColor.INDIGO, EnumColor.GRAY,
