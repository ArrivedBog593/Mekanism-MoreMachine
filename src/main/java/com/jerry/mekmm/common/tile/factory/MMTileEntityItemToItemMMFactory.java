...
public abstract class MMTileEntityItemToItemMMFactory<RECIPE extends MekanismRecipe> extends TileEntityMMFactory<RECIPE> {

    protected IInputHandler<@NotNull ItemStack>[] inputHandlers;
    protected IOutputHandler<@NotNull ItemStack>[] outputHandlers;

    protected MMTileEntityItemToItemMMFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
