...
//Lathe, Rolling_Mill
public class TileEntityItemStackToItemStackMMFactory extends MMTileEntityItemToItemMMFactory<ItemStackToItemStackRecipe> implements
    ...
    public TileEntityItemStackToItemStackMMFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
