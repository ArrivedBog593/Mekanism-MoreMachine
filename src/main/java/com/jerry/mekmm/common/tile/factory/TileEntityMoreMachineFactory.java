...
public abstract class TileEntityMoreMachineFactory<RECIPE extends MekanismRecipe<?>> extends TileEntityConfigurableMachine implements IRecipeLookupHandler<RECIPE> {
    ...
    private static class RecipeProcessInfo<RECIPE extends MekanismRecipe<?>> {
        ...
        @Nullable
        private ToIntBiFunction<RecipeProcessInfo<RECIPE>, TileEntityMoreMachineFactory<RECIPE>> lazyMinPerSlot;
        private Object item;
        private RECIPE recipe;
        private int minPerSlot = 1;
        private int totalCount;

        public int getMinPerSlot(TileEntityMoreMachineFactory<RECIPE> factory) {
