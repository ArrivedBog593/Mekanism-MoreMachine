...
public abstract class TileEntityItemToItemMoreMachineFactory<RECIPE extends MekanismRecipe> extends TileEntityMoreMachineFactory<RECIPE> {
    ...
    protected TileEntityItemToItemMoreMachineFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
