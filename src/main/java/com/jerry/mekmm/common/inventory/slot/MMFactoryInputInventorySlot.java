...
public class MMFactoryInputInventorySlot extends InputInventorySlot {
    ...
    public static MMFactoryInputInventorySlot create(TileEntityMMFactory<?> factory, int process, IInventorySlot outputSlot, @Nullable IContentsListener listener,
                                                     int x, int y) {
        return create(factory, process, outputSlot, null, listener, x, y);
    }

    public static MMFactoryInputInventorySlot create(TileEntityMMFactory<?> factory, int process, IInventorySlot outputSlot, @Nullable IInventorySlot secondaryOutputSlot,
    ...
    private MMFactoryInputInventorySlot(TileEntityMMFactory<?> factory, int process, IInventorySlot outputSlot, @Nullable IInventorySlot secondaryOutputSlot,
                                        @Nullable IContentsListener listener, int x, int y) {
