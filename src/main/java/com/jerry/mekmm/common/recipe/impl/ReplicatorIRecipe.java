...
public class ReplicatorIRecipe extends ItemStackGasToItemStackRecipe {
    ...
    public ReplicatorIRecipe(Item item, ItemStackIngredient itemInput, ChemicalStackIngredient.GasStackIngredient gasInput, ItemStack output) {
        this(Mekmm.rl("item_replicator/" + RegistryUtils.getName(item).toString().replace(':', '/')), itemInput, gasInput, output);
    }

    public ReplicatorIRecipe(ResourceLocation id, ItemStackIngredient itemInput, ChemicalStackIngredient.GasStackIngredient gasInput, ItemStack output) {
