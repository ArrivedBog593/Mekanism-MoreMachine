...
public class MoreMachineTwoInputCachedRecipe<INPUT_A, INPUT_B, OUTPUT, RECIPE extends MekanismRecipe<?> & BiPredicate<INPUT_A, INPUT_B>> extends TwoInputCachedRecipe<INPUT_A, INPUT_B, OUTPUT, RECIPE> {
    ...
    public static MoreMachineTwoInputCachedRecipe<ItemStack, ChemicalStack, PlantingRecipe.PlantingStationRecipeOutput, PlantingRecipe> planting(PlantingRecipe recipe, BooleanSupplier recheckAllErrors,
        ...
        return new MoreMachineTwoInputCachedRecipe<>(recipe, recheckAllErrors, itemInputHandler, chemicalInputHandler, outputHandler, recipe::getItemInput, recipe::getChemicalInput, recipe::getOutput,
