...
public class PlantingRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/oak_sapling"));
        //Dark Oak
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/dark_oak_sapling"));
        //Spruce
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/spruce_sapling"));
        //Birch
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/birch_sapling"));
        //Jungle
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/jungle_sapling"));
        //Acacia
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/mangrove_propagule"));
        //Cherry
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "sapling/cherry_sapling"));
        ...
        ).build(consumer, Mekmm.rl(basePath + "flower/torchflower"));
        //粉红色花簇
        PlantingStationRecipeBuilder.planting(
        ...
        ).build(consumer, Mekmm.rl(basePath + "flower/pitcher_plant"));
