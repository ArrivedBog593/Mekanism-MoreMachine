...
public class EMAdvancedFactoryRecipeProvider extends CompatRecipeProvider {
    ...
    protected void registerRecipes(RecipeOutput consumer, String basePath, Provider registries) {
        ...
        for (AdvancedFactoryType type : MoreMachineEnumUtils.ADVANCED_FACTORY_TYPES) {
            ...
            addFactoryRecipe(consumer, creativePath, AdvancedFactoryBlocks.getAdvancedFactory(EMFactoryTier.CREATIVE, type), multiversalFactory.getItemHolder(), Tags.Items.NETHER_STARS, EMTags.Items.ALLOYS_CREATIVE, EMTags.Items.CIRCUITS_CREATIVE_FORGE);
        }
    }

    private void addFactoryRecipe(RecipeOutput consumer, String basePath, BlockRegistryObject<BlockAdvancedFactory<?>, ?> factory, Holder<Item> toUpgrade,
